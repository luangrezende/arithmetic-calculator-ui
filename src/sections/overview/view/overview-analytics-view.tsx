...
import { fCurrency, formatCurrencyWithSymbol } from 'src/utils/format-number';
        ...
        <DashboardContent maxWidth="lg">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <ModernCard hoverable padding="none" className="h-full min-h-80">
                    ...
                    <ModernCard hoverable padding="none" className="h-full min-h-80">
                        <div className="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <div className="text-4xl font-bold text-green-600 dark:text-green-400 mb-6 flex items-baseline">
                                <span className="text-2xl mr-1">{formatCurrencyWithSymbol(dashboardData.totalCredit, currency).currency}</span>
                            ...
                            <div className="mt-auto">
                                ...
                                <div className="text-lg font-semibold text-green-700 dark:text-green-300 flex items-baseline">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <ModernCard hoverable padding="none" className="h-full min-h-75">
                        <div className="p-6 sm:p-8 h-full flex flex-col">
                            <div className="mb-6">
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
                                    Platform Overview
                        ...
                        <div className="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <div className="flex-1 space-y-6">
                                <div>
                                    ...
                                    <div className="text-3xl font-bold text-red-600 dark:text-red-400 flex items-baseline">
                                        <span className="text-xl mr-1">{formatCurrencyWithSymbol(dashboardData.totalPlatformCashSpent, currency).currency}</span>
                                ...
                                <div>
                                    ...
                                    <div className="text-3xl font-bold text-green-600 dark:text-green-400 flex items-baseline">
                                        <span className="text-xl mr-1">{formatCurrencyWithSymbol(dashboardData.totalPlatformCashAdded, currency).currency}</span>
                    ...
                    <ModernCard hoverable padding="none" className="h-full min-h-75">
                        <div className="p-6 sm:p-8 h-full flex flex-col">
                            ...
                            <div className="text-4xl font-bold text-amber-600 dark:text-amber-400 mb-6 flex items-baseline">
                                <span className="text-2xl mr-1">{formatCurrencyWithSymbol(dashboardData.annualTarget, currency).currency}</span>
